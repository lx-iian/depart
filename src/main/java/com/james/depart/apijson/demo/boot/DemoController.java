...
package com.james.depart.apijson.demo.boot;
...
import com.james.depart.apijson.demo.DemoFunctionParser;
import com.james.depart.apijson.demo.DemoVerifier;
import com.james.depart.apijson.demo.model.Privacy;
import com.james.depart.apijson.demo.model.User;
import com.james.depart.apijson.demo.model.Verify;
import com.james.depart.apijson.demo.DemoParser;
...
public class DemoController extends APIJSONController {
	...
	public DemoController(HttpServletRequest request, HttpServletResponse response) {
	...
	public String get(@RequestBody String request, HttpSession session) {
		String s = super.get(request, session);
		return s;
	}
