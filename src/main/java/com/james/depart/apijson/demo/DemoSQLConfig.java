...
package com.james.depart.apijson.demo;
...
public class DemoSQLConfig extends APIJSONSQLConfig {
	...
	public String getDBVersion() {
		if (isMySQL()) {
			return "5.7.17"; //"8.0.11"; //TODO 改成你自己的 MySQL 或 PostgreSQL 数据库版本号 //MYSQL 8 和 7 使用的 JDBC 配置不一样
		}
		if (isPostgreSQL()) {
	...
	public String getDBPassword() {
		if (isMySQL()) {
			return "zZ19951023";  //TODO 改成你自己的，TiDB 可以当成 MySQL 使用， 默认密码为空字符串 ""
		}
		if (isPostgreSQL()) {
